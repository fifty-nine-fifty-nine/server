...
public enum Species {
    ...
    dog("강아지", Arrays.asList("믹스견", "고든 세터", "골든 두들", "골든 리트리버", "그레이 하운드", "그레이트 데인", "그레이트 스위스 마운틴 도그",
            ...
            "실리함 테리어", "실키 테리어", "아나톨리안 마스티프", "아나톨리안 마스티프", "아나톨리안 셰퍼드독", "아메리칸 밴도지", "아메리칸 불리", "아메리칸 스태포드셔 테리어",
